...
export const DemoBanner: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-2xl transition-all duration-300">
      <div className="bg-slate-900 text-white rounded-3xl p-6 shadow-2xl border border-slate-700 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden animate-slide-in">
